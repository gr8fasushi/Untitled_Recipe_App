...
// Top values capped at 780px to avoid clustering at the bottom of pages.
export const BODY_DECOR_SETS: Record<string, DecorItem[]> = {
  home: [
    ...
    { emoji: '🧅', size: 60, opacity: 0.08, top: 780, left: '55%', rotate: '-5deg' },
    { emoji: '🫚', size: 80, opacity: 0.09, top: 50, left: '50%', rotate: '16deg' },
    { emoji: '🥗', size: 95, opacity: 0.1, top: 130, right: '20%', rotate: '-12deg' },
    { emoji: '🍜', size: 70, opacity: 0.08, top: 210, left: '70%', rotate: '20deg' },
    { emoji: '🫛', size: 105, opacity: 0.09, top: 290, right: 5, rotate: '-6deg' },
    { emoji: '🥑', size: 80, opacity: 0.1, top: 370, left: '48%', rotate: '10deg' },
    { emoji: '🌽', size: 65, opacity: 0.08, top: 450, right: '30%', rotate: '-18deg' },
    { emoji: '🍋', size: 85, opacity: 0.09, top: 530, left: 10, rotate: '15deg' },
    { emoji: '🥕', size: 75, opacity: 0.1, top: 610, left: '65%', rotate: '-8deg' },
    { emoji: '🍅', size: 90, opacity: 0.08, top: 690, right: '10%', rotate: '12deg' },
    { emoji: '🧆', size: 55, opacity: 0.09, top: 760, left: '38%', rotate: '-22deg' },
    { emoji: '🥦', size: 100, opacity: 0.1, top: 100, left: '25%', rotate: '5deg' },
    { emoji: '🧄', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🫒', size: 80, opacity: 0.09, top: 500, left: '78%', rotate: '-14deg' },
    { emoji: '🌶️', size: 70, opacity: 0.08, top: 580, right: '42%', rotate: '18deg' },
    { emoji: '🫑', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '🍄', size: 65, opacity: 0.09, top: 740, right: '25%', rotate: '8deg' },
    { emoji: '🥒', size: 85, opacity: 0.08, top: 30, right: '40%', rotate: '-16deg' },
  ],
  pantry: [
    ...
    { emoji: '🫛', size: 110, opacity: 0.1, top: 720, left: 25, rotate: '8deg' },
    { emoji: '🌶️', size: 60, opacity: 0.08, top: 780, left: '58%', rotate: '-5deg' },
    { emoji: '🍄', size: 80, opacity: 0.09, top: 50, left: '50%', rotate: '16deg' },
    { emoji: '🫒', size: 95, opacity: 0.1, top: 130, right: '22%', rotate: '-12deg' },
    { emoji: '🧄', size: 70, opacity: 0.08, top: 210, left: '72%', rotate: '18deg' },
    { emoji: '🥦', size: 55, opacity: 0.09, top: 290, right: 5, rotate: '-8deg' },
    { emoji: '🍅', size: 80, opacity: 0.1, top: 370, left: '45%', rotate: '10deg' },
    { emoji: '🌽', size: 65, opacity: 0.08, top: 450, right: '28%', rotate: '-18deg' },
    { emoji: '🥕', size: 85, opacity: 0.09, top: 530, left: 10, rotate: '15deg' },
    { emoji: '🫑', size: 75, opacity: 0.1, top: 610, left: '65%', rotate: '-8deg' },
    { emoji: '🧅', size: 90, opacity: 0.08, top: 690, right: '12%', rotate: '12deg' },
    { emoji: '🥑', size: 55, opacity: 0.09, top: 755, left: '35%', rotate: '-22deg' },
    { emoji: '🥒', size: 100, opacity: 0.1, top: 100, left: '28%', rotate: '5deg' },
    { emoji: '🍋', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🫛', size: 80, opacity: 0.09, top: 500, left: '75%', rotate: '-14deg' },
    { emoji: '🌶️', size: 70, opacity: 0.08, top: 580, right: '40%', rotate: '18deg' },
    { emoji: '🍄', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '🫒', size: 65, opacity: 0.09, top: 740, right: '22%', rotate: '8deg' },
    { emoji: '🧄', size: 85, opacity: 0.08, top: 30, right: '38%', rotate: '-16deg' },
  ],
  recipes: [
    { emoji: '🍳', size: 120, opacity: 0.1, top: 20, left: 15, rotate: '10deg' },
    { emoji: '🔥', size: 85, opacity: 0.09, top: 80, right: 20, rotate: '-12deg' },
    ...
    { emoji: '🫚', size: 60, opacity: 0.08, top: 780, left: '56%', rotate: '-5deg' },
    { emoji: '🥗', size: 80, opacity: 0.09, top: 50, left: '50%', rotate: '16deg' },
    { emoji: '🍜', size: 95, opacity: 0.1, top: 130, right: '20%', rotate: '-12deg' },
    { emoji: '🧆', size: 70, opacity: 0.08, top: 210, left: '70%', rotate: '20deg' },
    { emoji: '🍳', size: 55, opacity: 0.09, top: 290, right: 5, rotate: '-6deg' },
    { emoji: '🔥', size: 80, opacity: 0.1, top: 370, left: '48%', rotate: '10deg' },
    { emoji: '🥘', size: 65, opacity: 0.08, top: 450, right: '30%', rotate: '-18deg' },
    { emoji: '🫕', size: 85, opacity: 0.09, top: 530, left: 10, rotate: '15deg' },
    { emoji: '🥄', size: 75, opacity: 0.1, top: 610, left: '66%', rotate: '-8deg' },
    { emoji: '🧂', size: 90, opacity: 0.08, top: 690, right: '10%', rotate: '12deg' },
    { emoji: '🌿', size: 55, opacity: 0.09, top: 755, left: '38%', rotate: '-22deg' },
    { emoji: '🫙', size: 100, opacity: 0.1, top: 100, left: '26%', rotate: '5deg' },
    { emoji: '🍽️', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🫚', size: 80, opacity: 0.09, top: 500, left: '78%', rotate: '-14deg' },
    { emoji: '🥗', size: 70, opacity: 0.08, top: 580, right: '42%', rotate: '18deg' },
    { emoji: '🍜', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '🧆', size: 65, opacity: 0.09, top: 740, right: '25%', rotate: '8deg' },
    { emoji: '🥦', size: 85, opacity: 0.08, top: 30, right: '40%', rotate: '-16deg' },
  ],
  saved: [
    ...
    { emoji: '🍽️', size: 110, opacity: 0.1, top: 720, left: 25, rotate: '8deg' },
    { emoji: '🥘', size: 60, opacity: 0.08, top: 780, left: '57%', rotate: '-5deg' },
    { emoji: '🍳', size: 80, opacity: 0.09, top: 50, left: '50%', rotate: '16deg' },
    { emoji: '🌿', size: 95, opacity: 0.1, top: 130, right: '22%', rotate: '-12deg' },
    { emoji: '🧂', size: 70, opacity: 0.08, top: 210, left: '72%', rotate: '20deg' },
    { emoji: '🔖', size: 55, opacity: 0.09, top: 290, right: 5, rotate: '-8deg' },
    { emoji: '⭐', size: 80, opacity: 0.1, top: 370, left: '46%', rotate: '10deg' },
    { emoji: '❤️', size: 65, opacity: 0.08, top: 450, right: '28%', rotate: '-18deg' },
    { emoji: '🏆', size: 85, opacity: 0.09, top: 530, left: 10, rotate: '15deg' },
    { emoji: '📖', size: 75, opacity: 0.1, top: 610, left: '65%', rotate: '-8deg' },
    { emoji: '🌟', size: 90, opacity: 0.08, top: 690, right: '12%', rotate: '12deg' },
    { emoji: '💫', size: 55, opacity: 0.09, top: 755, left: '36%', rotate: '-22deg' },
    { emoji: '✨', size: 100, opacity: 0.1, top: 100, left: '28%', rotate: '5deg' },
    { emoji: '🎖️', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🍽️', size: 80, opacity: 0.09, top: 500, left: '76%', rotate: '-14deg' },
    { emoji: '🥘', size: 70, opacity: 0.08, top: 580, right: '40%', rotate: '18deg' },
    { emoji: '🍳', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '🌿', size: 65, opacity: 0.09, top: 740, right: '24%', rotate: '8deg' },
    { emoji: '🔖', size: 85, opacity: 0.08, top: 30, right: '38%', rotate: '-16deg' },
  ],
  profile: [
    ...
    { emoji: '🧂', size: 70, opacity: 0.08, top: 210, left: '70%', rotate: '20deg' },
    { emoji: '👤', size: 55, opacity: 0.09, top: 290, right: 5, rotate: '-6deg' },
    { emoji: '⚙️', size: 80, opacity: 0.1, top: 370, left: '47%', rotate: '10deg' },
    { emoji: '🔒', size: 65, opacity: 0.08, top: 450, right: '30%', rotate: '-18deg' },
    { emoji: '🛡️', size: 85, opacity: 0.09, top: 530, left: 10, rotate: '15deg' },
    { emoji: '📱', size: 75, opacity: 0.1, top: 610, left: '66%', rotate: '-8deg' },
    { emoji: '🔑', size: 90, opacity: 0.08, top: 690, right: '10%', rotate: '12deg' },
    { emoji: '💼', size: 55, opacity: 0.09, top: 755, left: '38%', rotate: '-22deg' },
    { emoji: '🎯', size: 100, opacity: 0.1, top: 100, left: '26%', rotate: '5deg' },
    { emoji: '🍽️', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🌿', size: 80, opacity: 0.09, top: 500, left: '77%', rotate: '-14deg' },
    { emoji: '⭐', size: 70, opacity: 0.08, top: 580, right: '42%', rotate: '18deg' },
    { emoji: '🥘', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '🍳', size: 65, opacity: 0.09, top: 740, right: '24%', rotate: '8deg' },
    { emoji: '🧂', size: 85, opacity: 0.08, top: 30, right: '40%', rotate: '-16deg' },
  ...
  community: [
    ...
    { emoji: '🍱', size: 100, opacity: 0.1, top: 100, left: '28%', rotate: '5deg' },
    { emoji: '🥗', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🫕', size: 80, opacity: 0.09, top: 500, left: '76%', rotate: '-14deg' },
    { emoji: '🍣', size: 70, opacity: 0.08, top: 580, right: '40%', rotate: '18deg' },
    { emoji: '🌯', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '⭐', size: 65, opacity: 0.09, top: 740, right: '24%', rotate: '8deg' },
    { emoji: '👨‍🍳', size: 85, opacity: 0.08, top: 30, right: '38%', rotate: '-16deg' },
  ...
  chat: [
    ...
    { emoji: '🍲', size: 80, opacity: 0.09, top: 50, left: '50%', rotate: '16deg' },
    { emoji: '🫕', size: 95, opacity: 0.1, top: 130, right: '20%', rotate: '-12deg' },
    { emoji: '🌶️', size: 70, opacity: 0.08, top: 210, left: '72%', rotate: '20deg' },
    { emoji: '👨‍🍳', size: 55, opacity: 0.09, top: 290, right: 5, rotate: '-6deg' },
    { emoji: '🍳', size: 80, opacity: 0.1, top: 370, left: '47%', rotate: '10deg' },
    { emoji: '💬', size: 65, opacity: 0.08, top: 450, right: '30%', rotate: '-18deg' },
    { emoji: '🥄', size: 85, opacity: 0.09, top: 530, left: 10, rotate: '15deg' },
    { emoji: '📝', size: 75, opacity: 0.1, top: 610, left: '65%', rotate: '-8deg' },
    { emoji: '🌿', size: 90, opacity: 0.08, top: 690, right: '10%', rotate: '12deg' },
    { emoji: '✨', size: 55, opacity: 0.09, top: 755, left: '38%', rotate: '-22deg' },
    { emoji: '🍽️', size: 100, opacity: 0.1, top: 100, left: '26%', rotate: '5deg' },
    { emoji: '🥘', size: 60, opacity: 0.08, top: 380, right: 40, rotate: '25deg' },
    { emoji: '🧂', size: 80, opacity: 0.09, top: 500, left: '77%', rotate: '-14deg' },
    { emoji: '🫙', size: 70, opacity: 0.08, top: 580, right: '42%', rotate: '18deg' },
    { emoji: '🍲', size: 95, opacity: 0.1, top: 660, left: 5, rotate: '-10deg' },
    { emoji: '🫕', size: 65, opacity: 0.09, top: 740, right: '24%', rotate: '8deg' },
    { emoji: '🌶️', size: 85, opacity: 0.08, top: 30, right: '40%', rotate: '-16deg' },
  ],
};
