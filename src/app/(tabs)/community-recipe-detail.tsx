      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        >
          ...
          >
            <LinearGradient
              colors={
                isDark ? ['#78350f', '#451a03', '#92400e'] : ['#451a03', '#92400e', '#f59e0b']
              }
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
            >
          ...
          {!sharedRecipe || !recipe ? (
            <View
              testID="community-detail-empty"
              className="items-center justify-center px-6 mt-20"
            >
                ...
                <View className="w-full max-w-2xl px-4 mt-5 relative">
                  ...
                  <View className="flex-row flex-wrap gap-2 mb-5">
                    ...
                    >
                      ...
                      <Text className="text-sm font-nunito-bold capitalize">
                        {recipe.difficulty}
                      </Text>
                    </View>
                  </View>
